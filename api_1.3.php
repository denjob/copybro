...
$url = 'http://copybro/api/notifications.get';
...
if(!empty($token)){
	...
	$data = array(
		// 'not_viewed_only' => 1, //опциональный параметр, чтобы получить список только непрочитанных уведомлений
	);
